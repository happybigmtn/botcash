...
│   └── logs/                   # Loop iteration logs
├── AGENTS.md                   # Operational guide (~60 lines max)
├── specs/                      # Requirement specs
│   ├── scaling_100x_plan.md
│   ├── scaling_500x_plan.md
│   └── devnet_100x.md
├── game/src/                   # On-chain Rust program
│   ├── instructions/v2/        # V2 instruction handlers
│   │   ├── settlement.rs       # Settlement orchestration
│   │   ├── settlement_plan.rs  # Read-only payout planning
│   │   └── settlement_exec.rs  # State mutation
│   └── state/v2.rs             # V2 account structures
├── scripts/                    # Off-chain TypeScript
│   ├── devnet_e2e.mts          # E2E test harness
│   ├── devnet_scale_ramp.mts   # Scale test orchestrator
│   ├── settlement_worker.mts   # Settlement drain service
│   ├── keeper.mts              # RNG crank service
│   └── lib/                    # Shared utilities
│       ├── kit-utils.mjs       # Solana Kit helpers
│       └── settlement-queue.mjs # Queue parsing
├── web/                        # React/Next.js frontend
├── mobile/                     # React Native app
├── executor/                   # Transaction relay service
...
```markdown
## Phase LUT-1: Address Lookup Tables

### LUT-1-T1 Create Drain LUT
- [ ] Add scripts/admin/create-drain-lut.mts
- [ ] Store LUT address in target/devnet-artifacts/

**Required Tests:**
- LUT contains program ID, treasury, global state
- Settlement drain with LUT reduces tx size

### LUT-1-T2 Update Drain Functions
- [ ] Modify drainSettlementQueue in devnet_e2e.mts
...
```
