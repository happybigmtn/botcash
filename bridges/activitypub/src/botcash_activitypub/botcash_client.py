"""Botcash JSON-RPC client for ActivityPub bridge operations."""
...
class BotcashClient:
    ...
    def compute_challenge_hash(self, challenge: str, actor_id: str) -> str:
        """Compute hash of challenge for verification.

        Args:
            challenge: The challenge string
            actor_id: ActivityPub actor ID

        Returns:
            SHA256 hash of challenge+actor_id
        """
        data = f"{challenge}:{actor_id}".encode()
    ...
    async def create_bridge_link(
        ...
        Args:
            ...
            platform: Platform name ("activitypub")
            platform_id: Platform user ID (actor URL)
            proof: Signed proof of identity
